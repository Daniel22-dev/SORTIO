...
const init=await readFile(new URL('../src/js/99-init.js',import.meta.url),'utf8');assert.ok(init.includes("document.readyState==='loading'")&&/else\s+(?:void\s+)?init\(\)/.test(init),'Inicializace musí fungovat i po DOMContentLoaded.');
