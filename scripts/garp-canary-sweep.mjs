...
const marker='GARP-STUDENT-CANARY-SORTIO-1.0.16-FINAL-1603';
const email=['garpstudentcanaryfinal1603.test','example.invalid'].join('@');
...
const report={schema:'sortio-garp-canary-sweep-v1',version:'1.0.16',syntheticOnly:true,marker:persistedMarker,email,before,after,status:'passed'};
