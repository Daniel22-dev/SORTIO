# SORTIO · Organizátor třídy 1.0.7 — etapa P2
...
- Vratná migrace aplikačních dat do prefixu `ghrab.sortio.*`; záloha se vytváří před odstraněním starých klíčů.
...
- PWA cache `ghrab-sortio-v__APP_VERSION__` a aktualizační zpráva `GHRAB_SKIP_WAITING`.
